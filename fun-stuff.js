...
let track_list = [
...

    {
        ...
        path: "Dragon Commander - Inuoh(CVAvuchan) - Topic (128k).mp3"
    },

    {
        name: "Earrings",
        path: "Earrings - Malcolm Todd (128k).mp3"
    },
     ...
     {
        name: "Lover you should come over",
        path: "Jeff Buckley - Lover, You Should've Come Over (Official Audio) - Jeff Buckley Music (128k).mp3"
    },
     {
